        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <FadeIn>
            ...
            <p className="text-slate-400 mb-8 text-lg">
              事業に関するお問い合わせ、パートナーシップのご相談など、<br />
              お気軽にご連絡ください。
            </p>
          ...
          <FadeIn delay={200}>
            <form onSubmit={handleSubmit} className="bg-slate-950 p-8 rounded-2xl border border-slate-800 shadow-xl">
              <div className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-slate-400 mb-1">お名前</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-slate-400 mb-1">メールアドレス</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-slate-400 mb-1">件名</label>
                  <input
                    type="text"
                    id="subject"
                    name="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-slate-400 mb-1">お問い合わせ内容</label>
                  <textarea
                    id="message"
                    name="message"
                    required
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center py-4 px-6 rounded-lg text-slate-950 font-bold transition-all ${
                    isSubmitting ? 'bg-slate-700 cursor-not-allowed text-slate-500' : 'bg-white hover:bg-brand hover:text-white shadow-[0_0_15px_rgba(255,255,255,0.3)] hover:shadow-[0_0_20px_rgba(0,175,204,0.6)]'
                  }`}
                >
