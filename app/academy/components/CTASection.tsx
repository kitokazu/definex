    ...
    <section className="py-24 bg-[#00afcc] text-white text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        <p className="text-lg md:text-xl text-cyan-50 mb-10 max-w-2xl mx-auto">
          スポーツの経験と英語力があれば、あなたの可能性は無限に広がります。<br/>
          まずは無料体験で、その一歩を踏み出しませんか？
        </p>
        <Button variant="white" className="text-xl py-4 px-10 shadow-2xl hover:scale-105 transform transition-transform">
          無料体験レッスンに申し込む
        </Button>
        <p className="mt-4 text-sm text-cyan-100 opacity-80">
