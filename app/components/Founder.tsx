...
const Founder: React.FC = () => {
  return (
    <section
      id="founder"
      className="py-24 bg-slate-900 overflow-hidden text-white relative"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          <div className="lg:col-span-5">
            <FadeIn direction="right" className="relative">
              <div className="aspect-4/5 rounded-lg overflow-hidden shadow-2xl bg-slate-800 border-2 border-slate-700 skew-x-[-3deg] relative">
                <Image
                  src="/taisei-headshot.jpg"
                  alt="北原 大誠 - Taisei Kitahara"
                  fill
                  className="object-cover opacity-90 skew-x-3 scale-110"
                />
              </div>
            </FadeIn>
          </div>
          ...
          <div className="lg:col-span-7 lg:pl-8">
            <FadeIn delay={200}>
              <div className="flex items-center space-x-4 mb-8">
                ...
                <div>
                  <h2 className="text-sm font-bold text-brand tracking-widest uppercase mb-1">
                    Founder Message
                  </h2>
              ...
              <div className="prose prose-lg prose-invert text-slate-300 leading-relaxed">
                ...
                <p>
                  幼少期より言葉、教育、文化、国籍の違う人と接することが当たり前の環境で過ごしました。そこで感じたのは、違うことが当たり前と思う自分と同じような人もいるけれど、そうではない人も実は多いということです。
                </p>
                ...
                <p>多くの人にサポートしてもらい、今の私があります。</p>

                <p>
                  今度は私がみなさんの自己を表現する場を一緒に見つけ、多くの人に感動体験を味わってもらいたいという想いから、DEFINE
                  X (ディファイン エックス) を創業しました。
                </p>
